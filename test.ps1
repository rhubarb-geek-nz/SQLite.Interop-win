...
Write-Host "Following should fail with missing entry point SI0773159780bced42 in SQLite.Interop.dll"

& "dotnet.exe" "bin\Release\net8.0\test.dll"

If ( $LastExitCode -eq 0 )
{
	throw "This should have failed with missing entry point SI0773159780bced42 in SQLite.Interop.dll"
}
